...
<img src="images/Add-workflow.png" alt="ワークフロー追加画面" style="display:block; border: 3px solid black; border-radius: 10px; width: 300px;">
...
<img src="images/add-http-trigger.png" alt="Http Trigger 追加画面" style="display:block;border: 3px solid black; border-radius: 10px; width: 500px;">
